...
import codeblocks from '../DatePicker/codeblocks';
          ...
          <Container fluid="sm" className="pt-5">
            ...
            <section>
              ...
              <p>
                ...
                transition is active for few milliseconds. When the animation is ending setting the
                new state <Badge bg="secondary">time</Badge> which will render the new month.
              </p>
            </section>
            <section>
              ...
              <Container>
                <Row>
                  ...
                  <Col lg="9">
                    <p>
                      When the date picker is rendered the first time the previous and next month
                      are both stored in 2 variables ready to be used when the transition is
                      triggered.
                      <br /> Clicking the arrow left will render the MonthCard component with the
                      current month along with the previous month on the left.
                      <br /> To handle the different phase we need 3 pieces of state:
                      <ol>
                        <li>
                          <Badge bg="secondary">activeTransition</Badge> when true the date picker
                          is rendered with 2 months.
                        </li>
                        <li>
                ...
                <Row className="mb-5">
                  ...
                  <Col lg="9">
                    <p>
                      ...
                      state is set to true. The entering phase is executed following by the exiting
                      phase. For our date picker we are only interested for one phase, here I went
                      for the exiting phase. That means the Transition component have the callback
                      onEntered to set the <Badge bg="secondary">inProp</Badge> state to false which
                      will trigger the exiting phase thus our animation. <br />
                      At the end of the animation the drop down show the next month but we still
                      have the initial month shown in the input and we still have the initial month
                      and the next month side by side. <br />
                    </p>
                  </Col>
                </Row>
                <Row>
              ...
              <Container>
                <Row>
                  ...
                  <Col lg="9">
                    ...
                    month showing in the dropdown because{' '}
                    ...
                    the time DatePicker component is rendered with the new month. It looks like that
                    the Transition container which have the css animation applied translate from
                    half a month card length.
                    <br />
                    All phases :
                    <ol>
                      <li>
                ...
                <Row>
                  ...
                  <Col lg="9">
                    ...
                    rerender all its children we can assume that the Transition container hasn't
                    changed at all, so during the reconciliation phase React doesn't unmount this
                    dom node. Because of this the css transition is still the same and we can see it
                    translating back to its initial position. To fix this we need to tell React to
                    unmount Transition container when a new time is set. We can simply add a key tag
                    to the transition container with the value of <Badge bg="secondary">time</Badge>{' '}
