      ...
      <Container fluid="sm" className={styles[`dateRangePage__wrapper`]}>
        ...
        <section>
          ...
          <p>
            ...
            <br /> highlighting today&apos;s date and a date prop in order to force the initial
          ...
          <Row>
            ...
            <Col lg={8}>
              <p>
                ...
                this stage. Then the Transition kicks off. At the end of the transition a state
                update with the new current month will show. <br />
                As long as you click a past day it will be considered as the start date. If a start
                and end are already selected a new click will reset the duration and set the new
                date as start date.
              </p>
            </Col>
          </Row>
        ...
        <section>
          ...
          <Row>
            ...
            <Col lg={8}>
              <p>
                If today is selected as start date it will behave as any another day with the
                normmal color. All past days are disabled to select. When a start and end date are
                selected the duration count should appear as information. Once finished to select a
                range{' '}
